    ...
    namespace sampleclient
    {
        ...
        */
        ...
        public:
            ...
            * @return the pointer of the created BGL graph.
            *
            */
            ...
            */
            std::vector<osmium::unsigned_object_id_type> hasDijkstraPath
            (osmium::unsigned_object_id_type from, std::vector<osmium::unsigned_object_id_type> to)
            {
                ...
                PredecessorMap predecessorMap(parents.data(), vertexIndexMap);
                DistanceMap distanceMap(distances.data(), vertexIndexMap);
